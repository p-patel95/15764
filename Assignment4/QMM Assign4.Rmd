...
lprec <- read.lp("Assign4.lp")        #Assigning variables to the linear program file
...
# Make an lp object with 0 constraints and 27 (dummy variables are added as demand and supply aren't equal) decision variables
lprec2 <- make.lp(0,27)

lp.control(lprec2,sense='min')

set.objfn(lprec2,c(1.52,1.60,1.40,1.70,1.63,1.55,1.45,1.57,1.30,5.15,5.12,5.32,5.69,5.47,6.16,6.13,6.05,6.25,5.63,6.12,6.17,5.80,5.71,5.87,0,0,0))

# Well supply constraints
